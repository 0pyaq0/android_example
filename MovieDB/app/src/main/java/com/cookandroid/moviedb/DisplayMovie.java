package com.cookandroid.moviedb;
...
public class DisplayMovie extends AppCompatActivity {
    ...
    TextView name, director, year, nation;
    Spinner rating; ImageView imgBack;
    int id = 0;
    ...
    public void insert(View view){
        ...
        if(extras!=null){
            int Value = extras.getInt("id");
            if(Value>0){
                if(mydb.updateMovie(id, name.getText().toString(), director.getText().toString(), year.getText().toString(), nation.getText().toString(), rating.getSelectedItem().toString())){
                ...
                if(mydb.insertMovie(name.getText().toString(), director.getText().toString(), year.getText().toString(), nation.getText().toString(), rating.getSelectedItem().toString())){
    ...
    public void delete(View view){
        ...
        if(extras!=null){
            ...
            if(Value>0){
                ...
                finish();
            }else{Toast.makeText(getApplicationContext(), "삭제되지 않았음", Toast.LENGTH_SHORT).show(); }
        }
    }
